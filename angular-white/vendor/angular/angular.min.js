...
(function(O, Y, u) {
	...
	function ua(b, a, c, d) {
		...
		if (a) {
			...
			if (J(b))
				for (var f = a.length = 0; f < b.length; f++) e = ua(b[f], null, c, d),
					F(b[f]) && (c.push(b[f]), d.push(e)), a.push(e);
			else {
				var g = a.$$hashKey;
	...
	function ka(b, a) {
		...
		if (c == typeof a && "object" == c)
			if (J(b)) {
				...
				for (d in a)
					if (!c.hasOwnProperty(d) && "$" !== d.charAt(0) && a[d] !== u && !C(a[d])) return !1;
				return !0
			}
		return !1
	}
	...
	function qc(b, a) {
		...
		b = I(b);
		for (d = 0; d < e; ++d)
			if (c = Ja[d] + a, M(c = b.attr(c))) return c;
		return null
	}
	...
	function nb(b, a) {
		...
		if (b.querySelectorAll)
			for (var c = b.querySelectorAll("*"), d = 0, e = c.length; d < e; d++) ob(c[d])
	}
	...
	function rf(b, a, c, d) {
		...
		n.cookies = function(a, b) {
			...
			if (a) b === u ? m.cookie = encodeURIComponent(a) + "=;path=" + C + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : M(b) && (d = (m.cookie = encodeURIComponent(a) + "=" + encodeURIComponent(b) +
				";path=" + C).length + 1, 4096 < d && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!"));
			else {
				if (m.cookie !== w)
					for (w = m.cookie, d = w.split("; "), p = {}, f = 0; f < d.length; f++) e = d[f], h = e.indexOf("="), 0 < h && (a = k(e.substring(0, h)), p[a] === u && (p[a] = k(e.substring(h + 1))));
				return p
			}
		};
	...
	function vc(b, a) {
			...
			M(a) ? (Mb(e, "directiveFactory"), d.hasOwnProperty(a) || (d[a] = [], b.factory(a + "Directive", ["$injector", "$exceptionHandler", function(b, e) {
				...
				r(d[a], function(d, h) {
					try {
						...
						C(g) ? g = {
							compile: oa(g)
						} : !g.compile && g.link && (g.compile = oa(g.link));
		...
		this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document",
			...
			function(a, b, c, x, y, q, z, A, v, B, K) {
				function N(a, b) {
					try {
						a.addClass(b)
					} catch (c) {}
				...
				function V(a, b, c, d, e, f) {
					function h(a, c, d, e) {
						var f, k, l, t, m, q, v;
						if (s)
							for (v = Array(c.length), t = 0; t < g.length; t += 3) f = g[t], v[f] = c[f];
						else v = c;
						t = 0;
						for (m = g.length; t < m;)
							if (k = v[g[t++]], c = g[t++], f = g[t++], c) {
								if (c.scope) {
					...
					for (var g = [], k, l, t, m, s, q = 0; q < a.length; q++) {
						...
						k = f && f.terminal || !(t = a[q].childNodes) || !t.length ? null : V(t, f ? (f.transcludeOnThisElement ||
				...
				function da(a, b, c, d, h) {
					...
					switch (a.nodeType) {
						case na:
							...
							F(a) && (a = a.animVal);
							if (M(a) && "" !== a)
								for (; k = f.exec(a);) l = wa(k[2]), X(b, l, "C", d, h) && (c[l] = W(k[3])), a = a.substr(k.index + k[0].length);
							break;
						case gb:
							Q(b, a.nodeValue);
							break;
				...
				function w(a, b, d, e, f, g, k, l, t) {
					...
					for (var x = -Number.MAX_VALUE, z, K = t.controllerDirectives, y, B = t.newIsolateScopeDirective, A = t.templateDirective, T = t.nonTlbTranscludeDirective, V = !1, Sb = !1, D = t.hasElementTranscludeDirective, X = d.$$element =
						...
						if (G = L.transclude) V = !0, L.$$tlb || (Ma("transclusion", T, L, X), T = L), "element" == G ? (D = !0, x = L.priority, G = X, X = d.$$element = I(Y.createComment(" " + ma + ": " + d[ma] + " ")), b = X[0],
							$(f, Va.call(G, 0), b), O = E(G, e, x, g && g.name, {
								nonTlbTranscludeDirective: T
							})) : (G = I(Pb(b)).contents(), X.empty(), O = E(G, e));
						if (L.template)
							if (Sb = !0, Ma("template", A, L, X), A = L, G = C(L.template) ? L.template(X, d) : L.template, G = ha(G), L.replace) {
								g = L;
				...
				function H(a) {
					for (var b = 0, c = a.length; b < c; b++) a[b] = Jb(a[b], {
						$$isolateScope: !0
					})
				}
				...
				function R(a, b, c, d, e, f, g, h) {
					var l = [],
						...
						z = C(s.templateUrl) ? s.templateUrl(b, c) : s.templateUrl,
						E = s.templateNamespace;
					b.empty();
				...
				ea.prototype = {
					...
					$set: function(a, b, d, e) {
						...
						g = ta(this.$$element);
						if ("a" === g && "href" === a || "img" === g && "src" === a) this[a] = b = K(b, "src" === a);
						else if ("img" === g && "srcset" === a) {
							for (var g = "", h = W(b), k = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, k = /\s/.test(h) ? k : /(,)/, h = h.split(k), k = Math.floor(h.length / 2), l = 0; l < k; l++) var t = 2 * l,
								g = g + K(W(h[t]), !0),
								g = g + (" " + W(h[t + 1]));
							h = W(h[2 * l]).split(/\s/);
							g += K(W(h[0]), !0);
				...
				function k(a) {
					...
					e.headers =
						function(a) {
							var c = b.headers,
								e = P({}, a.headers),
								f, g, h, c = P({}, c.common, c[G(a.method)]);
							a: for (f in c) {
								g = G(f);
								for (h in e)
									if (G(h) === g) continue a;
					...
					var f = [function(a) {
							var d = a.headers,
								e = Xc(a.data, Wc(d), u, a.transformRequest);
	...
	function Me() {
		...
		this.$get = ["$parse", "$exceptionHandler", "$sce", function(c, d, e) {
			...
			function h(f, h, m, n) {
				...
				n = !!n;
				for (var z, r, v = 0, B = [], K = [], N = f.length, E = [], p = []; v < N;)
					if (-1 != (z = f.indexOf(b, v)) && -1 !=
						(r = f.indexOf(a, z + l))) v !== z && E.push(g(f.substring(v, z))), v = f.substring(z + l, r), B.push(v), K.push(c(v, q)), v = r + k, p.push(E.length), E.push("");
					else {
		...
		this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", "$window", function(c, d, e, f, g) {
			...
			c.$watch(function() {
				var a = xb(d.url()),
					...
					f = d.state(),
					g = k.$$replace,
					t = a !== b || k.$$html5 && e.history && f !== k.$$state;
				...
				$watchCollection: function(a, b) {
					function c(a) {
						...
						if (!H(e)) {
							if (F(e))
								if (Oa(e))
									for (f !== n && (f = n, q = f.length = 0, k++), a = e.length, q !== a && (k++, f.length = q = a), b = 0; b < a; b++) h = f[b], g = e[b], d = h !== h && g !== g, d || h === g || (k++, f[b] = g);
								else {
									f !== t && (f = t = {}, q = 0, k++);
									a = 0;
									for (b in e) e.hasOwnProperty(b) && (a++, g = e[b], h = f[b], b in f ? (d = h !== h && g !== g, d || h === g || (k++, f[b] = g)) : (q++, f[b] = g, k++));
									if (q > a)
										for (b in k++, f) e.hasOwnProperty(b) || (q--, delete f[b])
								} else f !== e && (f = e, k++);
							return k
						}
					}
						...
						if (l)
							if (F(e))
								if (Oa(e)) {
									...
									for (a in h = {}, e) pc.call(e, a) && (h[a] = e[a]);
						else h = e
					})
				},
				$digest: function() {
						...
						a: do {
							if (m = u.$$watchers)
								for (n = m.length; n--;) try {
									if (e = m[n])
										if ((g = e.get(u)) !== (l = e.last) && !(e.eq ? ka(g, l) : "number" === typeof g && "number" === typeof l && isNaN(g) && isNaN(l))) r = !0, c = e, e.last = e.eq ? ua(g, null) : g, e.fn(g, l === t ? g : l, u), 5 > x && (Z = 4 - x, A[Z] || (A[Z] = []), A[Z].push({
							...
							if (!(m = u.$$watchersCount && u.$$childHead || u !== this && u.$$nextSibling))
								for (; u !== this && !(m = u.$$nextSibling);) u = u.$parent
						} while (u =
							m);
				...
				getTrusted: function(c, e) {
					...
					if (c === ja.RESOURCE_URL) {
						var g = ya(e.toString()),
							m, t, s = !1;
						m = 0;
						for (t = b.length; m < t; m++)
							if (d(b[m], g)) {
								s = !0;
								break
							}
						if (s)
							for (m = 0, t = a.length; m < t; m++)
								if (d(a[m], g)) {
									s = !1;
									break
								}
	...
	function Ye() {
		this.$get = ["$window", "$document", function(b, a) {
			var c = {},
				d = ba((/android (\d+)/.exec(G((b.navigator || {}).userAgent)) || [])[1]),
	...
	function Ha(b, a, c, d, e) {
		...
		switch (f) {
			case "object":
				...
				if ("object" === g) {
					for (h in a)
						if (e = a[h], !C(e) && (f = "$" === h, !Ha(f ? b : b[h], e, c, f, f))) return !1;
					return !0
				}
				return c(b, a);
			case "function":
	...
	function sd(b, a, c, d, e) {
		...
		if (g || k) 0 < e && 1 > b && (l = b.toFixed(e), b = parseFloat(l));
			...
			var g = ("" + b).split(td),
				...
				s = a.gSize;
			if (h.length >= t + s)
				for (m = h.length - t, k = 0; k < m; k++) 0 === (m - k) % s && 0 !== k && (l += c), l += h.charAt(k);
	...
	Qa.$inject = [];
	var J = Array.isArray,
		kc = /^\[object (Uint8(Clamped)?)|(Uint16)|(Uint32)|(Int8)|(Int16)|(Int32)|(Float(32)|(64))Array\]$/,
		W = function(b) {
			return M(b) ? b.trim() : b
		},
		ld = function(b) {
	...
	r({
		...
		attr: function(b, a, c) {
			...
			if (vb[d])
				...
				else return b[a] || (b.attributes.getNamedItem(a) || D).specified ? d : u;
			...
			search: function(a, c) {
				switch (arguments.length) {
					case 0:
						return this.$$search;
					case 1:
						if (M(a) || S(a)) a = a.toString(), this.$$search = oc(a);
						else if (F(a)) a = ua(a, {}), r(a, function(c, e) {
							null == c && delete a[e]
						}), this.$$search = a;
						else throw yb("isrcharg");
						break;
					default:
				...
				case p.MemberExpression:
					...
					k.recurse(a.object, h, u, function() {
						k.if(k.notNull(h), function() {
							if (a.computed) l = k.nextId(), k.recurse(a.property, l), k.addEnsureSafeMemberName(l), f && 1 !== f && k.if(k.not(k.computedMember(h, l)), k.lazyAssign(k.computedMember(h, l), "{}")), m = k.ensureSafeObject(k.computedMember(h, l)), k.assign(c, m), d && (d.computed = !0, d.name = l);
							else {
								za(a.property.name);
	...
	qa();
	qa();
	var Ff = Object.prototype.valueOf,
		Aa = R("$sce"),
		ja = {
			HTML: "html",
			CSS: "css",
	...
	var td = ".",
		...
		Of = /((?:[^yMdHhmsaZEw']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z|w+))(.*)/,
		Nf = /^\-?\d+$/;
	pd.$inject = ["$locale"];
	var Kf = oa(G),
		Lf = oa(lb);
		...
		Id = {
			...
			checkbox: function(a, c, d, e, f, g, h, l) {
				var k = zd(l, a, "ngTrueValue", d.ngTrueValue, !0),
					n = zd(l, a, "ngFalseValue", d.ngFalseValue, !1);
				c.on("click", function(a) {
	...
	var me = ["$animate", function(a) {
		...
		Cd = "ng-pending",
		Hb = new R("ngModel"),
		eg = ["$scope", "$exceptionHandler", "$attrs",
			...
			function(a, c, d, e, f, g, h, l, k, n) {
				...
				var z = e.inheritedData("$formController") || Eb,
					A = 0;
				xd({
					ctrl: this,
					$element: e,
				...
				this.$$runValidators = function(a, c, d, e) {
					...
					(function(a) {
						...
						if (a === u) h(c, null);
						else if (h(c, a), !a) return r(q.$validators, function(a, c) {
							h(c,
								null)
				...
				this.$$parseAndValidate = function() {
					var c = q.$$lastCommittedViewValue,
						d = H(c) ? u : !0;
					if (d)
						for (var e = 0; e < q.$parsers.length; e++)
							if (c = q.$parsers[e](c), H(c)) {
								d = !1;
								break
							}
					S(q.$modelValue) && isNaN(q.$modelValue) &&
						(q.$modelValue = s(a));
					var f = q.$modelValue,
						g = q.$options && q.$options.allowInvalid;
					q.$$rawModelValue = c;
		...
		gg = R("ngOptions"),
		hg = /^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/,
		...
		qe = ["$locale", "$interpolate", "$log", function(a, c, d) {
			...
			return {
				...
				link: function(g,
					...
					var n = l.count,
						m = l.$attr.when && h.attr(l.$attr.when),
						p = l.offset || 0,
						s = g.$eval(m) || {},
						u = {},
						y = c.startSymbol(),
					...
					return function(a, f, g, k, n) {
						...
						a.$watchCollection(m, function(g) {
							...
							if (Oa(g)) H = g, m = z || A;
								...
								for (J in m = z || v, H = [], g) g.hasOwnProperty(J) && "$" !== J.charAt(0) && H.push(J);
							E = H.length;
							J = Array(E);
							for (k = 0; k < E; k++)
								if (D = g === H ? k : H[k], G = g[D], C = m(D, G, k), s[C]) F = s[C], delete s[C], B[C] = F, J[k] = F;
								else {
							...
							for (k = 0; k < E; k++)
								if (D = g === H ? k : H[k], G = g[D], F = J[k], F.scope) {
									w = q;
